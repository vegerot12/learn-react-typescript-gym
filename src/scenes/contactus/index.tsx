...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-48">
      <motion.div
        ...
        <motion.div
          ...
          <p className="my-5">A long para</p>
        </motion.div>
        {/* Form and image */}
        <div className="mt-10 justify-between gap-8 md:flex">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            variants={{
              hidden: { opacity: 0, y: -50 }, // initially opacity is 0 and it starts to move from -50
